...
class VideoVaultActivity : AppCompatActivity() {
    ...
    private fun importFile(uri: android.net.Uri) {
        if (vaultManager.encryptAndStore(uri, this, "video")) {
            Toast.makeText(this, "Video hidden", Toast.LENGTH_SHORT).show(); refresh()
    ...
    private fun startSelectionMode() {
        ...
        actionMode = startSupportActionMode(object : ActionMode.Callback {
            ...
            override fun onDestroyActionMode(mode: ActionMode?) {
                ...
                (binding.recyclerView.adapter as? VideoAdapter)?.notifyDataSetChanged()
            }
        })
    }
    ...
    private fun confirmDeleteSelected() {
        AlertDialog.Builder(this, R.style.DarkAlertDialog)
            ...
            .setPositiveButton("Trash") { _, _ -> selectedFiles.forEach { vaultManager.moveToTrash(it, "video") }; refresh() }
    ...
    private fun confirmUnhideSelected() {
        AlertDialog.Builder(this, R.style.DarkAlertDialog)
            ...
            .setPositiveButton("Restore") { _, _ ->
                var success = 0
                selectedFiles.forEach { if (vaultManager.unhideToPublic(this, it, "video")) success++ }
    ...
    private inner class VideoAdapter(private val files: List<File>) : RecyclerView.Adapter<VideoAdapter.VH>() {
        ...
        override fun onBindViewHolder(h: VH, i: Int) {
            ...
            h.itemView.setOnClickListener {
                ...
                else { startActivity(Intent(this@VideoVaultActivity, VideoPlayerActivity::class.java).putExtra("path", file.absolutePath)) }
            }
